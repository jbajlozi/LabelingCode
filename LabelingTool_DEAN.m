...
% cd '~';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CHANGE HERE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Days_labeling={[],[],[],[],[],	[],[],[],[13],[], [],[]}; %What sessions you want to look at
path_orig = 'D:\No_Flex\College\UCLA\UCLA_Real_Life\Research\Robas\P4 bank of data- wo videos'; %Path to P4 bank of data- wo videos

predictedLabels = false;%Run with true to get predicted labels
testLabels = false; %Run with true to have the lines you created display on the graph
testLabels_time = true; %Run with true to use video time as labels
...
time_stamp = [0.32 .405 1.31];
act_samp = [143 358 1623];
freq_acc = .01;
...
for f = 1:length(ids)    
    ...
    %% Glitches of magnetometer
        ...
        for r_1 = 1:length(time_log)
            ...
            %calculate expected sample position and store into array
